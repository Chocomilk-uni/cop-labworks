...
namespace PdfPluginImplementation
{
    public partial class FormReport : Form
    {
        ...
        {
            if (!reportBuilder.AddParagraph(new ParagraphConfigModel()
            {
            ...
            if (!reportBuilder.AddTable(new TableConfigModel()
            {
            ...
            if (!reportBuilder.AddChart(new ChartConfigModel
            {
            ...
            if (!reportBuilder.AddImage(new ImageConfigModel()
            {
                ImagePath = imagePath,
                Width = 16,
                Height = 12
            })) return false;
            return reportBuilder.SaveDocument(filePath);
        }
    }
}
